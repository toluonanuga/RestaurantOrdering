        ...
        <span style="white-space:nowrap"> <!--forces the labels to not wrap with spaces !-->
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <form action="DeliveryChoice" method="POST"> 
                    <input type="submit" name="takeout" value="takeout" class="btn btn-primary btn-md center-block" Style="width: 25%;" role="button" />
                    <input type="submit" name="delivery" value="delivery" class="btn btn-primary btn-md center-block" Style="width: 25%;" role="button" />
                    </form>
                </div>
            </div>
        </span>
