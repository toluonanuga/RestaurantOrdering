                    ...
                    <span style="white-space:nowrap"> <!--forces the labels to not wrap with spaces !-->
                        ...
                        <form action = "checkout" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="recieverFirstname" class="form-control" name="recieverFirstname" placeholder="First Name">
                                </div>
                                <label for="recieverLastname" class="col-sm-2 col-form-label">Last Name:</label>
                                <div class="col-sm-4">
                                    <input type="recieverLastname" class="form-control" name="recieverLastname" placeholder="Last Name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="recieverEmail" class="col-sm-2 col-form-label">Email:</label>
                                <div class="col-sm-4">
                                    <input type="recieverEmail" class="form-control" name="recieverEmail" placeholder="Email">
                                </div>                                
